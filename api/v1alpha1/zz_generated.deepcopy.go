...
func (in *K3sConfigAgent) DeepCopyInto(out *K3sConfigAgent) {
	*out = *in
	if in.KubeletArg != nil {
		in, out := &in.KubeletArg, &out.KubeletArg
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.NodeLabel != nil {
	...
	if in.NodeTaint != nil {
		in, out := &in.NodeTaint, &out.NodeTaint
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *K3sIstallOptions) DeepCopyInto(out *K3sIstallOptions) {
	*out = *in
	...
	if in.ConfigFileArgs != nil {
		in, out := &in.ConfigFileArgs, &out.ConfigFileArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
